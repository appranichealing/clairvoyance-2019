...
this.$el=$el;this.setData().setOptions(opts).build().events();return this},setData:function(){this.$el.data(instanceName,this);return this},setOptions:function(opts){this.options=$.extend(!0,{},PluginLazyLoad.defaults,opts,{wrapper:this.$el});return this},build:function(){if(!($.isFunction($.fn.lazyload))){return this}
...
if(!$(this).closest('li').hasClass('open')){var $li=$(this).closest('li'),isSub=!1;if($(this).parent().hasClass('dropdown-submenu')){isSub=!0}
